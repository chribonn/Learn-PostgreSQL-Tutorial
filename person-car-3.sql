-- install the extension if it necessary
...
insert into person (person_uid, first_name, last_name, gender, email, date_of_birth, country_of_birth) 
	values (uuid_generate_v4(), 'Adriana', 'Matuschek', 'Female', 'amatuschek2@freeburner.com', '1965-02-28', 'Cameroon');
...
insert into car (car_uid, make, model, price) 
	values (uuid_generate_v4(), 'GMC', 'Acadia', 17662.99);
